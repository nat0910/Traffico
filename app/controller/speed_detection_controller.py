...
from app.utils.speed_estimate import SpeedEstimator
import threading
import queue
import time

# Initialize the camera, model, and SpeedEstimator
camera = cv2.VideoCapture('videos/detect.mp4')  # Ensure correct video source path
...
def process_frames():
    while True:
        ...
        frame = speed_obj.estimate_speed(frame, tracks, path='instance/data/violation-detected/speed-violation', speed_threshold=40)
